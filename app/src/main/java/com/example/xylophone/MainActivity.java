...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHSoundId=mSoundPool.load(getApplicationContext(),R.raw.note6_h,1);
        mISoundId=mSoundPool.load(getApplicationContext(),R.raw.note7_i,1);
